<template>
	<div class="topDiv">		
		<div class="catalog">
			<div class="cataTop">
				<h4>目录</h4>
				<!-- <i class="el-icon-minus minButton" @click=""/> -->
			</div>
			<div>			
				<input type="button" value=" + 同级目录" @click="addSameLevel"/>
				<input type="button" value=" + 子级目录" @click="addChildLevel" style="margin-left:10px;" >
